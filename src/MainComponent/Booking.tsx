...
const Booking = () => {
  return (
    <div className="flex items-start gap-6 my-8 mx-24">
    <div className="w-[35%] bg-white shadow-lg rounded-lg border border-gray-200  p-6">
      <div className="flex items-center border-b pb-3">
        ...
        />
        <div>
          <h2 className="text-lg font-[Poppins,Sans-serif] font-semibold">Calabro Beach Club</h2>
          <p className="text-sm font-[Poppins,Sans-serif] text-gray-500">9 promenade de la mer, Menton, France</p>
        </div>
      </div>
